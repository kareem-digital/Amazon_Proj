...
| Part | Kya hai |
|---|---|
| **A** | Technical foundation — advertising ecosystem, CTV vs non-CTV, teen deal types deep dive, CPM family, 1P/2P/3P data, reach ka ganit, baaki sab terms |
...
## A4. 🔴 Teen Deal Types — DEEP DIVE

Ye Part A ka sabse zaroori section hai. Schema document me §2.3 me ye teen hain, aur David ka Comment 1 aur Comment 18 dono inhi par hain.

### Pehle: "Deal" kya hai?

**Deal = publisher aur khareedar ke beech ek pehle se tay kiya hua intezaam** — kis daam par, kaunsi inventory, kaun khareed sakta hai.

Deal ke bina jo hota hai use **Open Auction** kehte hain — sabke liye khula, koi rishta nahi. Deal ke saath aapko **pehle access** milta hai, ya **behtar daam**, ya **guarantee**.

Har deal ka ek **Deal ID** hota hai — jaise `EXT245WE18EEMKX`. Wo ID DSP me daalne se wo specific inventory unlock hoti hai.

### Chaar levels — sabse khula se sabse committed tak

```
                    Kaun khareed sakta hai?    Daam?         Volume guarantee?
                    
1. OPEN AUCTION     koi bhi                    auction       ❌
2. PRIVATE AUCTION  sirf invited khareedar     floor + auction ❌
3. PREFERRED DEAL   sirf tum                   FIXED          ❌
4. PROGRAMMATIC     sirf tum                   FIXED          ✅ HAAN
   GUARANTEED
   
   ← zyada azadi                              zyada certainty →
```

VOW ke schema me **teen** hain (Open Auction CTV me use nahi hota — premium publishers apni inventory khuli auction me nahi daalte).

---

### 4.1 🔵 PRIVATE AUCTION (PMP — Private Marketplace)

**Ek line me:** Ek **band auction** — sirf invited khareedar hi bid kar sakte hain, aur ek **minimum daam (floor)** hai jiske upar bid karna padta hai.

**Kaise kaam karta hai:**
```
Netflix bolta hai:
  "Meri UK Streaming TV inventory ka floor £22.96 CPM hai.
   Mai 8 DSPs ko invite kar raha hoon.
   Jo sabse zyada bid karega, use slot milega.
   Par £22.96 se kam koi bid accept nahi hogi."

Ad slot khaali hua:
  Amazon DSP    bid £24.00   ← jeet gaya, £24 pay karega
  Trade Desk    bid £23.50
  DV360         bid £22.96
  
Aapka slot mila. Aapne £24 diya.
```

**Zaroori baat:** `FLOOR_RATE` ka matlab hai **£22.96 se shuru hota hai, £22.96 par khatam nahi hota.** Actual daam auction tay karta hai.

| Pehlu | Detail |
|---|---|
| **Price type** | `FLOOR_RATE` — minimum, competitive |
| **Bid ka kaam?** | ✅ **HAAN** — aapko floor se upar bid karna padta hai |
| **Volume guarantee** | ❌ Nahi — jeetoge to milega, nahi to nahi |
| **Budget commitment** | ❌ Koi nahi — £10,000 daala, £3,000 kharch hua to £7,000 wapas |
| **Pause kar sakte ho?** | ✅ Haan, kabhi bhi |
| **Kaun jeetega?** | Pata nahi — competition par depend |

**Kab use karo:**
- Reach ka target hai, exact volume ka nahi
- Budget flexible rakhna hai
- Test kar rahe ho — commit nahi karna
- Ek se zyada publisher par phaylana hai

**Risk:**
```
Aapne £10,000 daala, floor £22.96.
Us mahine competition tez ho gaya — sab £30+ bid kar rahe hain.
Aap £24 bid kar rahe ho → aap har jagah HAAR rahe ho.
Result: £10,000 me se sirf £2,000 kharch hua. Campaign under-deliver hua.

Isliye "reach" ka andaza lagana mushkil hai — pata nahi kitni baar jeetoge.
```

**🔴 VOW me reality:** Maine staging par 83 deals dekhi — **lagbhag SAARI `PRIVATE_AUCTION` + `FLOOR_RATE` hain.** Netflix ki saari, Freewheel ki saari, aur **Prime Video ki bhi kuch.**

Isliye VOW platform **base bid required** rakhta hai. (Ye Comment 12 ke liye critical hai.)

---

### 4.2 🟢 PREFERRED DEAL

**Ek line me:** **Fixed daam** par inventory ka **pehla haq** — par kharidne ki koi majboori nahi.

**Kaise kaam karta hai:**
```
Prime Video bolta hai:
  "Tumhare liye £15.26 CPM fix. Pakka daam, koi auction nahi.
   Jab bhi mera slot khaali hoga, mai PEHLE tumhe puchunga.
   Tum 'haan' bolo to £15.26 par tumhara.
   Tum 'na' bolo to mai auction me daal dunga.
   Aur mai tumhe kuch bhi khareedne ke liye majboor nahi karta."

Slot khaali hua:
  → Prime Video → Amazon DSP se puchta hai "chahiye? £15.26"
  → Aapka campaign chal raha hai, budget hai → "haan"
  → Slot mil gaya, £15.26 pay kiya. Koi auction nahi hua.
  
  Agar aapka budget khatam ho gaya → "na"
  → Prime Video wo slot auction me daal deta hai
```

Isko **"first look"** ya **"right of first refusal"** kehte hain.

| Pehlu | Detail |
|---|---|
| **Price type** | `FIXED_CPM` — pakka daam |
| **Bid ka kaam?** | ❌ **NAHI** — daam already tay hai, bid karne ki zaroorat nahi |
| **Volume guarantee** | ❌ Nahi — priority hai par guarantee nahi |
| **Budget commitment** | ❌ Koi nahi |
| **Pause kar sakte ho?** | ✅ Haan |
| **Priority** | Open auction se **pehle**, PG ke **baad** |

**Kab use karo:**
- Premium inventory chahiye, par flexibility bhi
- Daam pakka pata hona chahiye (planning aasan)
- Auction me compete nahi karna
- Par poora budget commit nahi karna

**Risk:**
```
Guarantee nahi hai. Agar Prime Video par PG deals pehle se bhari hui hain,
to aapko slots hi nahi milenge — jabki daam pakka tha.

Aur agar apka campaign paused tha jab slot aaya — mauka gaya.
```

**🔴 VOW me reality:** Prime Video ki `Prime Video | Preferred Deal | Video | UK - 15, 20 – ROS` type deals `PREFERRED` + `FIXED_CPM` hain (£15.26, £24.79). Ye Amazon-owned inventory hai.

---

### 4.3 🔴 PROGRAMMATIC GUARANTEED (PG)

**Ek line me:** **Fixed daam + guaranteed volume.** Publisher volume dega, aur aap **poora budget dene ke liye bandhe hue ho** — chahe use karo ya na karo.

Ye programmatic me **sabse zyada commitment** wala sauda hai. Asal me ye purana TV/print wala contract hai, programmatic pipes ke through chalaya gaya.

**Kaise kaam karta hai:**
```
Prime Video aur VOW me contract:
  "£20 CPM par 300,000 impressions, 1-30 September.
   Total £6,000.
   Mai 300,000 impressions PAKKA dunga.
   Tum £6,000 PAKKA dega — chahe campaign chale ya na chale."

Koi auction nahi. Koi bid nahi. Koi competition nahi.
Slot khaali hua → seedha aapka ad chala. Bas.

Agar aap 15 September ko campaign pause kar do:
  → Aapne 150,000 impressions use kiye
  → Par aap phir bhi £6,000 dene ke liye bandhe ho
  → Ya kam se kam contract ke terms ke hisab se penalty
```

| Pehlu | Detail |
|---|---|
| **Price type** | `FIXED_CPM` |
| **Bid ka kaam?** | ❌ Nahi — auction hi nahi hota |
| **Volume guarantee** | ✅ **HAAN** — publisher deliver karne ke liye bandha hai |
| **Budget commitment** | 🔴 **POORA BUDGET OWED** — chahe use karo ya na |
| **Pause kar sakte ho?** | 🔴 **NAHI** |
| **Priority** | Sabse pehli — sab se upar |

**Kab use karo:**
- Ek **event** hai jise miss nahi kar sakte — World Cup final, product launch day, Black Friday
- Client ne exact impressions ka wada kiya hai
- Premium inventory jo auction me mil hi nahi sakti (Super Bowl slot)
- Reach ka pakka commitment chahiye

**Risk — aur ye sabse bada risk hai:**
```
£6,000 committed. Campaign week 1 me hi pata chala ki creative galat hai.
Aap pause karna chahte ho.
→ NAHI KAR SAKTE. Ya paise doobenge.

Ya: client ne budget ghata diya.
→ Fark nahi padta. £6,000 owed hai.
```

**🔴🔴 Ye schema ke liye kyun sabse zaroori hai:**

Comment 18 me David ne kaha *"deals ko chupa do, sirf CPM dikhao"*. Par PG me **paise ka commitment** chupa nahi sakte:

```
❌ GALAT — agent ye kare:
   "Mujhe Prime Video par £22 CPM mil raha hai. Aage badhun?"
   [andar wo ek PG deal hai — £6,000 committed, pause nahi ho sakta]
   Trader "haan" bolta hai, use pata nahi ki wo bandh gaya.

✅ SAHI — agent ye kare:
   "Mujhe Prime Video par £22 CPM mil raha hai.
    Ye ek GUARANTEED deal hai — poora £6,000 committed hoga
    aur campaign pause nahi kar sakenge. Aage badhun?"
```

Ye **schema me likha hua hai** — Comment 18 ka review note: *"Commercial commitment. Hiding the deal must not hide that."*

**🔴 VOW me reality:** Filter me `Programmatic Guaranteed` option hai, par staging ki 83 deals me **ek bhi PG deal nahi mili.** Ye ek open question hai — PG kabhi aati hai ya nahi.

---

### 4.4 Teeno ka side-by-side comparison

| | **Private Auction** | **Preferred Deal** | **Programmatic Guaranteed** |
|---|---|---|---|
| **Doosra naam** | PMP, PA | First Look, PD | PG, Guaranteed |
| **Daam** | Floor + auction | Fixed | Fixed |
| **VOW ka field** | `FLOOR_RATE` | `FIXED_CPM` | `FIXED_CPM` |
...
| **Aam taur par CPM** | Sasta | Beech | Mehnga |
| **VOW me kitni** | 🔴 **Lagbhag saari** | Kuch (Prime Video) | Ek bhi nahi mili |

### 4.5 🔴 "Kya choose karenge to kya hoga" — Agent ke liye faisla
...
### 4.6 Har choice ka asar — teen jagah
...
### 4.7 Ek yaad rakhne wala shortcut

```
PRIVATE AUCTION   =  "Sale me line me lag ke bidding karo"
                     Sasta, par pakka nahi

PREFERRED DEAL    =  "Shop tumhe pehle bulati hai, daam pakka"
                     Pakka daam, par stock ki guarantee nahi

PROG. GUARANTEED  =  "Advance me pura order book kar diya, paise diye"
                     Sab pakka, par paise wapas nahi
```

---

## A5. CPM ka poora parivaar

**CPM = Cost Per Mille** — *mille* Latin me hazaar. Yaani **1,000 impressions ka daam.**

**Kyun 1,000 par?** Kyunki ek impression ka daam £0.022 jaisa hoga — padhna mushkil. £22 per 1,000 padhna aasan.
...
Example:
   Budget £10,000, CPM £22.96
   → impressions = (10000 ÷ 22.96) × 1000 = 435,540
```

### CPM ki saat kism — sab alag cheez hain
...
| **Base bid** | Aap kitna bid karenge | Trader daalta hai |
...
Impressions:
   Deal CPM se:      (10000 ÷ 22.96) × 1000 = 435,540
   Effective se:     (10000 ÷ 24.59) × 1000 = 406,669
   
   Farak: 28,871 impressions (7% kam!)
```

🔴 **Agar agent sirf deal CPM se calculate karega to trader ko 7% zyada impressions batayega — aur wo galat hoga.** Isi liye schema me §2.4 me likha hai: *"the agent should surface the effective CPM (deal + audience fee), not just the deal price."*

### 🔴 Ek trap — teen alag CPM ek hi plan me

Maine staging par ye dekha:
```
Trader ne deals chuni:      £24.79  aur  £34.80
Forecast ne avg_cpm diya:   £7.60   aur  £23.98
```
**Bahut bada farak!** Kyunki forecast poori supply ka blended average leta hai, sirf chuni gayi deals ka nahi.

To jab koi puche *"CPM kitna hai?"* — pehle puchna padega **"kaunsa CPM?"**

---

## A6. 1P, 2P, 3P Data — aur fees
...
## A7. Reach, Frequency, Impressions — ka poora ganit
...
## A8. Endemic vs Non-Endemic (On/Off Amazon)
